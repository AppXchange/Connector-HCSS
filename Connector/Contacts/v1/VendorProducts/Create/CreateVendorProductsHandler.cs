...
public class CreateVendorProductsHandler : IActionHandler<CreateVendorProductsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateVendorProductsActionOutput>();
            // response = await _apiClient.PostVendorProductsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetVendorProductsDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateVendorProductsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(VendorProductsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateVendorProductsHandler" };
