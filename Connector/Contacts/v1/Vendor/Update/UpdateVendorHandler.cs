...
public class UpdateVendorHandler : IActionHandler<UpdateVendorAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateVendorActionOutput>();
            // response = await _apiClient.PostVendorDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetVendorDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateVendorActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(VendorDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateVendorHandler" };
