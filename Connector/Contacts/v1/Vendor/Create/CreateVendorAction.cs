...
public class CreateVendorAction : IStandardAction<CreateVendorActionInput, CreateVendorActionOutput>
{
    public CreateVendorActionInput ActionInput { get; set; } = new() { Code = string.Empty };
    public CreateVendorActionOutput ActionOutput { get; set; } = new();
    public StandardActionFailure ActionFailure { get; set; } = new();

    public bool CreateRtap => true;
}

public class CreateVendorActionInput
{
    ...
    [Description("The vendor's type unique identifier")]
...
public class CreateVendorActionOutput
{
    [JsonPropertyName("id")]
    [Description("The created vendor's unique identifier")]
