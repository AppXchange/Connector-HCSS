...
public class UpdateProductTypeHandler : IActionHandler<UpdateProductTypeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateProductTypeActionOutput>();
            ...
            // var resource = new UpdateProductTypeActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateProductTypeHandler" };
