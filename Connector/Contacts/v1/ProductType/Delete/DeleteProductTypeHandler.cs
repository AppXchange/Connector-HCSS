...
public class DeleteProductTypeHandler : IActionHandler<DeleteProductTypeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteProductTypeActionOutput>();
            ...
            // var resource = new DeleteProductTypeActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteProductTypeHandler" };
