...
public class CreateProductTypeHandler : IActionHandler<CreateProductTypeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateProductTypeActionOutput>();
            // response = await _apiClient.PostProductTypeDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetProductTypeDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateProductTypeActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(ProductTypeDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateProductTypeHandler" };
