...
public class DeleteContactProductsHandler : IActionHandler<DeleteContactProductsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteContactProductsActionOutput>();
            // response = await _apiClient.PostContactProductsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetContactProductsDataObject(response.Data.id, cancellationToken);

            // var resource = new DeleteContactProductsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(ContactProductsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteContactProductsHandler" };
