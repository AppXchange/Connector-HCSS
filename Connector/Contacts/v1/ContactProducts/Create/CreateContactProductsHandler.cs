...
public class CreateContactProductsHandler : IActionHandler<CreateContactProductsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateContactProductsActionOutput>();
            ...
            // var resource = new CreateContactProductsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateContactProductsHandler" };
