...
public class PartialChangeProjectHandler : IActionHandler<PartialChangeProjectAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<PartialChangeProjectActionOutput>();
            ...
            // var resource = new PartialChangeProjectActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "PartialChangeProjectHandler" };
