...
public class DeleteReleaseOrderApprovalRuleHandler : IActionHandler<DeleteReleaseOrderApprovalRuleAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteReleaseOrderApprovalRuleActionOutput>();
            // response = await _apiClient.PostReleaseOrderApprovalRuleDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetReleaseOrderApprovalRuleDataObject(response.Data.id, cancellationToken);

            // var resource = new DeleteReleaseOrderApprovalRuleActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(ReleaseOrderApprovalRuleDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteReleaseOrderApprovalRuleHandler" };
