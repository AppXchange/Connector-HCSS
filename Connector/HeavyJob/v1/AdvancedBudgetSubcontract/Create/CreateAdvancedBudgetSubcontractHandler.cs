...
public class CreateAdvancedBudgetSubcontractHandler : IActionHandler<CreateAdvancedBudgetSubcontractAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateAdvancedBudgetSubcontractActionOutput>();
            // response = await _apiClient.PostAdvancedBudgetSubcontractDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetAdvancedBudgetSubcontractDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateAdvancedBudgetSubcontractActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(AdvancedBudgetSubcontractDataObject), CacheChanges = operations.ToArray() }
            };
