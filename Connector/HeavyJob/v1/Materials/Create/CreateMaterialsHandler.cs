...
public class CreateMaterialsHandler : IActionHandler<CreateMaterialsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateMaterialsActionOutput>();
            ...
            // var resource = new CreateMaterialsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateMaterialsHandler" };
