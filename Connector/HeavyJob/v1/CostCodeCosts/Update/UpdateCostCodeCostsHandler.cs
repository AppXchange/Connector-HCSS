...
public class UpdateCostCodeCostsHandler : IActionHandler<UpdateCostCodeCostsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateCostCodeCostsActionOutput>();
            // response = await _apiClient.PostCostCodeCostsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCostCodeCostsDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateCostCodeCostsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(CostCodeCostsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateCostCodeCostsHandler" };
