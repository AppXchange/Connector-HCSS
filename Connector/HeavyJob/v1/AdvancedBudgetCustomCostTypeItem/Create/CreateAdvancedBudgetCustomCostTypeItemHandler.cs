...
public class CreateAdvancedBudgetCustomCostTypeItemHandler : IActionHandler<CreateAdvancedBudgetCustomCostTypeItemAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateAdvancedBudgetCustomCostTypeItemActionOutput>();
            // response = await _apiClient.PostAdvancedBudgetCustomCostTypeItemDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetAdvancedBudgetCustomCostTypeItemDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateAdvancedBudgetCustomCostTypeItemActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(AdvancedBudgetCustomCostTypeItemDataObject), CacheChanges = operations.ToArray() }
            };
