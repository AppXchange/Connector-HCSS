...
public class DeleteCostAdjustmentsHandler : IActionHandler<DeleteCostAdjustmentsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteCostAdjustmentsActionOutput>();
            ...
            // var resource = new DeleteCostAdjustmentsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteCostAdjustmentsHandler" };
