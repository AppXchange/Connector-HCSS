...
public class UpdateCostAdjustmentsHandler : IActionHandler<UpdateCostAdjustmentsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateCostAdjustmentsActionOutput>();
            ...
            // var resource = new UpdateCostAdjustmentsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateCostAdjustmentsHandler" };
