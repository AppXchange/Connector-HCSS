...
public class CreatePayItemsHandler : IActionHandler<CreatePayItemsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePayItemsActionOutput>();
            // response = await _apiClient.PostPayItemsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPayItemsDataObject(response.Data.id, cancellationToken);

            // var resource = new CreatePayItemsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PayItemsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePayItemsHandler" };
