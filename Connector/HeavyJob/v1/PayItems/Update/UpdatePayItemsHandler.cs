...
public class UpdatePayItemsHandler : IActionHandler<UpdatePayItemsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdatePayItemsActionOutput>();
            ...
            // var resource = new UpdatePayItemsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdatePayItemsHandler" };
