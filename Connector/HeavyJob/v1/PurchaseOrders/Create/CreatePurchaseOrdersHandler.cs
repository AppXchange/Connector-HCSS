...
public class CreatePurchaseOrdersHandler : IActionHandler<CreatePurchaseOrdersAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePurchaseOrdersActionOutput>();
            ...
            // var resource = new CreatePurchaseOrdersActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePurchaseOrdersHandler" };
