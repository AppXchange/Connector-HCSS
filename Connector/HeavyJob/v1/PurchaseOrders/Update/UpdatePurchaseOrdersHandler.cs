...
public class UpdatePurchaseOrdersHandler : IActionHandler<UpdatePurchaseOrdersAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdatePurchaseOrdersActionOutput>();
            // response = await _apiClient.PostPurchaseOrdersDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPurchaseOrdersDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdatePurchaseOrdersActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PurchaseOrdersDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdatePurchaseOrdersHandler" };
