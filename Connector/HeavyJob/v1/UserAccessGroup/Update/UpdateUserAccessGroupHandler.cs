...
public class UpdateUserAccessGroupHandler : IActionHandler<UpdateUserAccessGroupAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateUserAccessGroupActionOutput>();
            ...
            // var resource = new UpdateUserAccessGroupActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateUserAccessGroupHandler" };
