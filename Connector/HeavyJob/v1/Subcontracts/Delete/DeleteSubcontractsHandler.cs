...
public class DeleteSubcontractsHandler : IActionHandler<DeleteSubcontractsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteSubcontractsActionOutput>();
            ...
            // var resource = new DeleteSubcontractsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteSubcontractsHandler" };
