...
public class CreateSubcontractsHandler : IActionHandler<CreateSubcontractsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateSubcontractsActionOutput>();
            // response = await _apiClient.PostSubcontractsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetSubcontractsDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateSubcontractsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(SubcontractsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateSubcontractsHandler" };
