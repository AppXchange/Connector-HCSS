...
public class UpdateSubcontractsHandler : IActionHandler<UpdateSubcontractsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateSubcontractsActionOutput>();
            ...
            // var resource = new UpdateSubcontractsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateSubcontractsHandler" };
