...
public class UpdateCostCodeTagsHandler : IActionHandler<UpdateCostCodeTagsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateCostCodeTagsActionOutput>();
            ...
            // var resource = new UpdateCostCodeTagsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateCostCodeTagsHandler" };
