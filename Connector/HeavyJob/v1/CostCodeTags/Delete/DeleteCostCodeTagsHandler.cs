...
public class DeleteCostCodeTagsHandler : IActionHandler<DeleteCostCodeTagsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteCostCodeTagsActionOutput>();
            ...
            // var resource = new DeleteCostCodeTagsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteCostCodeTagsHandler" };
