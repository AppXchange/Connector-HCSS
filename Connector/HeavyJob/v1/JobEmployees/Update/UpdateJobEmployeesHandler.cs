...
public class UpdateJobEmployeesHandler : IActionHandler<UpdateJobEmployeesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateJobEmployeesActionOutput>();
            ...
            // var resource = new UpdateJobEmployeesActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateJobEmployeesHandler" };
