...
public class CreateMaterialPurchaseOrderDetailsHandler : IActionHandler<CreateMaterialPurchaseOrderDetailsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateMaterialPurchaseOrderDetailsActionOutput>();
            ...
            // var resource = new CreateMaterialPurchaseOrderDetailsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateMaterialPurchaseOrderDetailsHandler" };
