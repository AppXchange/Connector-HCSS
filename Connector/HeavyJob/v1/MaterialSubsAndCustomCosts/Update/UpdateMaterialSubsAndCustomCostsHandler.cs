...
public class UpdateMaterialSubsAndCustomCostsHandler : IActionHandler<UpdateMaterialSubsAndCustomCostsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateMaterialSubsAndCustomCostsActionOutput>();
            // response = await _apiClient.PostMaterialSubsAndCustomCostsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetMaterialSubsAndCustomCostsDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateMaterialSubsAndCustomCostsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(MaterialSubsAndCustomCostsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateMaterialSubsAndCustomCostsHandler" };
