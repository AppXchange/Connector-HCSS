...
public class CreateJobCustomCostTypeItemHandler : IActionHandler<CreateJobCustomCostTypeItemAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateJobCustomCostTypeItemActionOutput>();
            ...
            // var resource = new CreateJobCustomCostTypeItemActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateJobCustomCostTypeItemHandler" };
