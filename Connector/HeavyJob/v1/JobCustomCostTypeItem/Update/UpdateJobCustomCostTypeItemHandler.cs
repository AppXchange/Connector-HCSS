...
public class UpdateJobCustomCostTypeItemHandler : IActionHandler<UpdateJobCustomCostTypeItemAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateJobCustomCostTypeItemActionOutput>();
            ...
            // var resource = new UpdateJobCustomCostTypeItemActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateJobCustomCostTypeItemHandler" };
