...
public class CreateJobMaterialHandler : IActionHandler<CreateJobMaterialAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateJobMaterialActionOutput>();
            ...
            // var resource = new CreateJobMaterialActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateJobMaterialHandler" };
