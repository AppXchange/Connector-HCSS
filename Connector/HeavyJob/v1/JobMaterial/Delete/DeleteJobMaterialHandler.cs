...
public class DeleteJobMaterialHandler : IActionHandler<DeleteJobMaterialAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteJobMaterialActionOutput>();
            ...
            // var resource = new DeleteJobMaterialActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteJobMaterialHandler" };
