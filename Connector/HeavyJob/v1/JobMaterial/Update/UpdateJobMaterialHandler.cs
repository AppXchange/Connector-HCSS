...
public class UpdateJobMaterialHandler : IActionHandler<UpdateJobMaterialAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateJobMaterialActionOutput>();
            // response = await _apiClient.PostJobMaterialDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetJobMaterialDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateJobMaterialActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(JobMaterialDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateJobMaterialHandler" };
