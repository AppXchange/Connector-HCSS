...
public class CreateCostCodeTransactionHandler : IActionHandler<CreateCostCodeTransactionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCostCodeTransactionActionOutput>();
            // response = await _apiClient.PostCostCodeTransactionDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCostCodeTransactionDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateCostCodeTransactionActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(CostCodeTransactionDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateCostCodeTransactionHandler" };
