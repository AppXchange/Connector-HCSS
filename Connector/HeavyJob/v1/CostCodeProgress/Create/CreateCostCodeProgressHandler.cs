...
public class CreateCostCodeProgressHandler : IActionHandler<CreateCostCodeProgressAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCostCodeProgressActionOutput>();
            // response = await _apiClient.PostCostCodeProgressDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCostCodeProgressDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateCostCodeProgressActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(CostCodeProgressDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateCostCodeProgressHandler" };
