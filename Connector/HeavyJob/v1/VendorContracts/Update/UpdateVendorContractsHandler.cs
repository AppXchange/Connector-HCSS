...
public class UpdateVendorContractsHandler : IActionHandler<UpdateVendorContractsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateVendorContractsActionOutput>();
            ...
            // var resource = new UpdateVendorContractsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateVendorContractsHandler" };
