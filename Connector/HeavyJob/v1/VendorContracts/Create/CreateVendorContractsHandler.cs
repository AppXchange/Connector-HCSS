...
public class CreateVendorContractsHandler : IActionHandler<CreateVendorContractsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateVendorContractsActionOutput>();
            // response = await _apiClient.PostVendorContractsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetVendorContractsDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateVendorContractsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateVendorContractsHandler" };
