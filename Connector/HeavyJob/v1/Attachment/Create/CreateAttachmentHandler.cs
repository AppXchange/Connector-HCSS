...
public class CreateAttachmentHandler : IActionHandler<CreateAttachmentAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateAttachmentActionOutput>();
            // response = await _apiClient.PostAttachmentDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetAttachmentDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateAttachmentActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(AttachmentDataObject), CacheChanges = operations.ToArray() }
            };
