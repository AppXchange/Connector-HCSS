...
public class CreateCustomCostTypeInstalledHandler : IActionHandler<CreateCustomCostTypeInstalledAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCustomCostTypeInstalledActionOutput>();
            // response = await _apiClient.PostCustomCostTypeInstalledDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCustomCostTypeInstalledDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateCustomCostTypeInstalledActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(CustomCostTypeInstalledDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateCustomCostTypeInstalledHandler" };
