...
public class UpdateJobSubcontractHandler : IActionHandler<UpdateJobSubcontractAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateJobSubcontractActionOutput>();
            ...
            // var resource = new UpdateJobSubcontractActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateJobSubcontractHandler" };
