...
public class DeleteJobSubcontractHandler : IActionHandler<DeleteJobSubcontractAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteJobSubcontractActionOutput>();
            // response = await _apiClient.PostJobSubcontractDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetJobSubcontractDataObject(response.Data.id, cancellationToken);

            // var resource = new DeleteJobSubcontractActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(JobSubcontractDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteJobSubcontractHandler" };
