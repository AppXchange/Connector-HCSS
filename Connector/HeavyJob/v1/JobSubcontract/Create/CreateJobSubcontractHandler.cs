...
public class CreateJobSubcontractHandler : IActionHandler<CreateJobSubcontractAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateJobSubcontractActionOutput>();
            ...
            // var resource = new CreateJobSubcontractActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateJobSubcontractHandler" };
