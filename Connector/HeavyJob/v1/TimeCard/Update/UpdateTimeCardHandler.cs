...
public class UpdateTimeCardHandler : IActionHandler<UpdateTimeCardAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateTimeCardActionOutput>();
            // response = await _apiClient.PostTimeCardDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetTimeCardDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateTimeCardActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(TimeCardDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateTimeCardHandler" };
