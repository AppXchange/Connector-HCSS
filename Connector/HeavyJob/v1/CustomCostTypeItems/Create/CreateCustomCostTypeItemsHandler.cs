...
public class CreateCustomCostTypeItemsHandler : IActionHandler<CreateCustomCostTypeItemsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCustomCostTypeItemsActionOutput>();
            ...
            // var resource = new CreateCustomCostTypeItemsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateCustomCostTypeItemsHandler" };
