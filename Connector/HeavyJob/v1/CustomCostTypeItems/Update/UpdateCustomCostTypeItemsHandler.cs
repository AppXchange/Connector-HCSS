...
public class UpdateCustomCostTypeItemsHandler : IActionHandler<UpdateCustomCostTypeItemsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateCustomCostTypeItemsActionOutput>();
            // response = await _apiClient.PostCustomCostTypeItemsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCustomCostTypeItemsDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateCustomCostTypeItemsActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateCustomCostTypeItemsHandler" };
