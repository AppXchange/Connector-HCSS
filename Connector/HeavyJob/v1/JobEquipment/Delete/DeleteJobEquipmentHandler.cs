...
public class DeleteJobEquipmentHandler : IActionHandler<DeleteJobEquipmentAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteJobEquipmentActionOutput>();
            ...
            // var resource = new DeleteJobEquipmentActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteJobEquipmentHandler" };
