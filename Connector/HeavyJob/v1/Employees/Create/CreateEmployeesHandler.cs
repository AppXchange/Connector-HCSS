...
namespace Connector.HeavyJob.v1.Employees.Create;
...
public class CreateEmployeesHandler : IActionHandler<CreateEmployeesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            // response = await _apiClient.PostEmployeesDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetEmployeesDataObject(response.Data.id, cancellationToken);
