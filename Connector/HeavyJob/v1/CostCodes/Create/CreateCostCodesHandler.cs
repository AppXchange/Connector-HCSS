...
public class CreateCostCodesHandler : IActionHandler<CreateCostCodesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCostCodesActionOutput>();
            ...
            // var resource = new CreateCostCodesActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateCostCodesHandler" };
