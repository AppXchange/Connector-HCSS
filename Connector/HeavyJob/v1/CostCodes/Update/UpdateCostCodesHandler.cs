...
public class UpdateCostCodesHandler : IActionHandler<UpdateCostCodesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateCostCodesActionOutput>();
            // response = await _apiClient.PostCostCodesDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCostCodesDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateCostCodesActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(CostCodesDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateCostCodesHandler" };
