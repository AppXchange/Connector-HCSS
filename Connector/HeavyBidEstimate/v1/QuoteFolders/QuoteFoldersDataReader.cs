...
public class QuoteFoldersDataReader : TypedAsyncDataReaderBase<QuoteFoldersDataObject>
{
    ...
    public override async IAsyncEnumerable<QuoteFoldersDataObject> GetTypedDataAsync(
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ApiResponse<HeavyBidResponse<QuoteFoldersDataObject>> response;
            try
            {
                response = await _apiClient.GetAllQuoteFolders(
