...
public class BiditemsDataReader : TypedAsyncDataReaderBase<BiditemsDataObject>
{
    ...
    public override async IAsyncEnumerable<BiditemsDataObject> GetTypedDataAsync(
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ApiResponse<HeavyBidResponse<BiditemsDataObject>> response;
            try
            {
                response = await _apiClient.GetBiditems(
