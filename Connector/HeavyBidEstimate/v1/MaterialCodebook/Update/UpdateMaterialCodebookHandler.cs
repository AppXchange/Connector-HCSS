...
public class UpdateMaterialCodebookHandler : IActionHandler<UpdateMaterialCodebookAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateMaterialCodebookActionOutput>();
            // response = await _apiClient.PostMaterialCodebookDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetMaterialCodebookDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateMaterialCodebookActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(MaterialCodebookDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateMaterialCodebookHandler" };
