...
public class UpdateSkillHandler : IActionHandler<UpdateSkillAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateSkillActionOutput>();
            // response = await _apiClient.PostSkillDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetSkillDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateSkillActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(SkillDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateSkillHandler" };
