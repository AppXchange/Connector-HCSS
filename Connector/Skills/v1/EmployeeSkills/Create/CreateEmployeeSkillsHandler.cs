...
public class CreateEmployeeSkillsHandler : IActionHandler<CreateEmployeeSkillsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateEmployeeSkillsActionOutput>();
            // response = await _apiClient.PostEmployeeSkillsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetEmployeeSkillsDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateEmployeeSkillsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(EmployeeSkillsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateEmployeeSkillsHandler" };
