...
public class CreateEmployeeSkillImportHandler : IActionHandler<CreateEmployeeSkillImportAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateEmployeeSkillImportActionOutput>();
            // response = await _apiClient.PostEmployeeSkillImportDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetEmployeeSkillImportDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateEmployeeSkillImportActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(EmployeeSkillImportDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateEmployeeSkillImportHandler" };
