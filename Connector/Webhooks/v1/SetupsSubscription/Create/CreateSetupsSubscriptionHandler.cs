...
public class CreateSetupsSubscriptionHandler : IActionHandler<CreateSetupsSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateSetupsSubscriptionActionOutput>();
            ...
            // var resource = new CreateSetupsSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateSetupsSubscriptionHandler" };
