...
public class DeleteSetupsSubscriptionHandler : IActionHandler<DeleteSetupsSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteSetupsSubscriptionActionOutput>();
            ...
            // var resource = new DeleteSetupsSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteSetupsSubscriptionHandler" };
