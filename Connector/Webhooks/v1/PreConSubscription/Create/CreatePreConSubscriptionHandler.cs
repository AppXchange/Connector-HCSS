...
public class CreatePreConSubscriptionHandler : IActionHandler<CreatePreConSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePreConSubscriptionActionOutput>();
            ...
            // var resource = new CreatePreConSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePreConSubscriptionHandler" };
