...
public class DeletePreConSubscriptionHandler : IActionHandler<DeletePreConSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeletePreConSubscriptionActionOutput>();
            // response = await _apiClient.PostPreConSubscriptionDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPreConSubscriptionDataObject(response.Data.id, cancellationToken);

            // var resource = new DeletePreConSubscriptionActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PreConSubscriptionDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeletePreConSubscriptionHandler" };
