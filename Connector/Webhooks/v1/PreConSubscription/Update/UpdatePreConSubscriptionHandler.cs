...
public class UpdatePreConSubscriptionHandler : IActionHandler<UpdatePreConSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdatePreConSubscriptionActionOutput>();
            ...
            // var resource = new UpdatePreConSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdatePreConSubscriptionHandler" };
