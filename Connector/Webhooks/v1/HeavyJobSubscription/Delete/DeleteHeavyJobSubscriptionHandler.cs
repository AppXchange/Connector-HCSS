...
public class DeleteHeavyJobSubscriptionHandler : IActionHandler<DeleteHeavyJobSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteHeavyJobSubscriptionActionOutput>();
            ...
            // var resource = new DeleteHeavyJobSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteHeavyJobSubscriptionHandler" };
