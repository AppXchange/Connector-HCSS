...
public class CreateFileHandler : IActionHandler<CreateFileAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateFileActionOutput>();
            // response = await _apiClient.PostFileDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetFileDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateFileActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(FileDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateFileHandler" };
