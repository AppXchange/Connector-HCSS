...
public class CreateInvoiceHandler : IActionHandler<CreateInvoiceAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateInvoiceActionOutput>();
            // response = await _apiClient.PostInvoiceDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetInvoiceDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateInvoiceActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(InvoiceDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateInvoiceHandler" };
