...
public class UpdatePartsHandler : IActionHandler<UpdatePartsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdatePartsActionOutput>();
            // response = await _apiClient.PostPartsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPartsDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdatePartsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PartsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdatePartsHandler" };
