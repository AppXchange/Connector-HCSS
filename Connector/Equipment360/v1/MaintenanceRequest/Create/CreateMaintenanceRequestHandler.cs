...
public class CreateMaintenanceRequestHandler : IActionHandler<CreateMaintenanceRequestAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateMaintenanceRequestActionOutput>();
            // response = await _apiClient.PostMaintenanceRequestDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetMaintenanceRequestDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateMaintenanceRequestActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(MaintenanceRequestDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateMaintenanceRequestHandler" };
