...
public class UpdateEmployeeHandler : IActionHandler<UpdateEmployeeAction>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var response = await _apiClient.UpdateEmployee(input, cancellationToken);
                ...
                return ActionHandlerOutcome.Failed(new StandardActionFailure
                {
                    ...
                    Errors = new[]
                    {
                        new Error
                        {
                            ...
                            Text = $"Failed to update employee with status code {response.StatusCode}"
                        }
                    }
                });
            }
        ...
        {
            _logger.LogError(exception, "Exception while updating employee");
