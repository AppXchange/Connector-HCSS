...
public class CreateWorkOrderNotesHandler : IActionHandler<CreateWorkOrderNotesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateWorkOrderNotesActionOutput>();
            // response = await _apiClient.PostWorkOrderNotesDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetWorkOrderNotesDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateWorkOrderNotesActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(WorkOrderNotesDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateWorkOrderNotesHandler" };
