...
public class CreateCustomFieldHandler : IActionHandler<CreateCustomFieldAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCustomFieldActionOutput>();
            // response = await _apiClient.PostCustomFieldDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCustomFieldDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateCustomFieldActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(CustomFieldDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateCustomFieldHandler" };
