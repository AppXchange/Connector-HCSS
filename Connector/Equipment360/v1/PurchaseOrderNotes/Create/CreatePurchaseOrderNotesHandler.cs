...
public class CreatePurchaseOrderNotesHandler : IActionHandler<CreatePurchaseOrderNotesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePurchaseOrderNotesActionOutput>();
            // response = await _apiClient.PostPurchaseOrderNotesDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPurchaseOrderNotesDataObject(response.Data.id, cancellationToken);

            // var resource = new CreatePurchaseOrderNotesActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PurchaseOrderNotesDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePurchaseOrderNotesHandler" };
