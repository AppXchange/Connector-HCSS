...
public class UpdateWorkOrderHandler : IActionHandler<UpdateWorkOrderAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateWorkOrderActionOutput>();
            ...
            // var resource = new UpdateWorkOrderActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateWorkOrderHandler" };
