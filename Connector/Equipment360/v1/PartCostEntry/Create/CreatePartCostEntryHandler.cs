...
public class CreatePartCostEntryHandler : IActionHandler<CreatePartCostEntryAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePartCostEntryActionOutput>();
            // response = await _apiClient.PostPartCostEntryDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPartCostEntryDataObject(response.Data.id, cancellationToken);

            // var resource = new CreatePartCostEntryActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PartCostEntryDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePartCostEntryHandler" };
