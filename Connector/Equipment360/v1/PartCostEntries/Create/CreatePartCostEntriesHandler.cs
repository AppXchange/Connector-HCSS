...
public class CreatePartCostEntriesHandler : IActionHandler<CreatePartCostEntriesAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePartCostEntriesActionOutput>();
            // response = await _apiClient.PostPartCostEntriesDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPartCostEntriesDataObject(response.Data.id, cancellationToken);

            // var resource = new CreatePartCostEntriesActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PartCostEntriesDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePartCostEntriesHandler" };
