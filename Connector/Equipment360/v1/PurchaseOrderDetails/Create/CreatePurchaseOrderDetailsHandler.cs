...
public class CreatePurchaseOrderDetailsHandler : IActionHandler<CreatePurchaseOrderDetailsAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePurchaseOrderDetailsActionOutput>();
            // response = await _apiClient.PostPurchaseOrderDetailsDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPurchaseOrderDetailsDataObject(response.Data.id, cancellationToken);

            // var resource = new CreatePurchaseOrderDetailsActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PurchaseOrderDetailsDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePurchaseOrderDetailsHandler" };
