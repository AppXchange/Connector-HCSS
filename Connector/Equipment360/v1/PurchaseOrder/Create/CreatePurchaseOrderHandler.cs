...
public class CreatePurchaseOrderHandler : IActionHandler<CreatePurchaseOrderAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreatePurchaseOrderActionOutput>();
            // response = await _apiClient.PostPurchaseOrderDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetPurchaseOrderDataObject(response.Data.id, cancellationToken);

            // var resource = new CreatePurchaseOrderActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(PurchaseOrderDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreatePurchaseOrderHandler" };
