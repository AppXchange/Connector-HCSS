...
/// are intended to be.
/// </summary>
[Description("Creates a new cost code in HCSS")]
public class CreateCostCodeAction : IStandardAction<CreateCostCodeActionInput, CreateCostCodeActionOutput>
{
    public CreateCostCodeActionInput ActionInput { get; set; } = new() 
    { 
        Code = string.Empty,
        BusinessUnitCode = string.Empty,
        JobCode = string.Empty
    };
    public CreateCostCodeActionOutput ActionOutput { get; set; } = new()
    {
        Code = string.Empty,
        BusinessUnitCode = string.Empty,
        JobCode = string.Empty
...
public class CreateCostCodeActionInput
{
...
public class CreateCostCodeActionOutput : CostCodeDataObject
{
}
