...
public class CreateCostCodeHandler : IActionHandler<CreateCostCodeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateCostCodeActionOutput>();
            // response = await _apiClient.PostCostCodeDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCostCodeDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateCostCodeActionOutput
            // {
            //      TODO : map
            // };
