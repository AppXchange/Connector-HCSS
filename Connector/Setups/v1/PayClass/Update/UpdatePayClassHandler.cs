...
namespace Connector.Setups.v1.PayClass.Update;
...
public class UpdatePayClassHandler : IActionHandler<UpdatePayClassAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdatePayClassActionOutput>();
            ...
            // var resource = new UpdatePayClassActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdatePayClassHandler" };
