...
public class CreateBulkCostCodeHandler : IActionHandler<CreateBulkCostCodeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateBulkCostCodeActionOutput>();
            // response = await _apiClient.PostBulkCostCodeDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetBulkCostCodeDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateBulkCostCodeActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(BulkCostCodeDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateBulkCostCodeHandler" };
