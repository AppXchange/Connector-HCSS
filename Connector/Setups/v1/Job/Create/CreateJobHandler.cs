...
namespace Connector.Setups.v1.Job.Create;

public class CreateJobHandler : IActionHandler<CreateJobAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<CreateJobActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<CreateJobActionOutput>();
            ...
            // var resource = new CreateJobActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(JobDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateJobHandler" };
