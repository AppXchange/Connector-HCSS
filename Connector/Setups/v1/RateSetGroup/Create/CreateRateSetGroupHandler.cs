...
public class CreateRateSetGroupHandler : IActionHandler<CreateRateSetGroupAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateRateSetGroupActionOutput>();
            // response = await _apiClient.PostRateSetGroupDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetRateSetGroupDataObject(response.Data.id, cancellationToken);

            // var resource = new CreateRateSetGroupActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(RateSetGroupDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateRateSetGroupHandler" };
