...
public class UpdateRateSetGroupHandler : IActionHandler<UpdateRateSetGroupAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateRateSetGroupActionOutput>();
            ...
            // var resource = new UpdateRateSetGroupActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateRateSetGroupHandler" };
