...
public class UpdateRateSetEquipmentHandler : IActionHandler<UpdateRateSetEquipmentAction>
{
    private readonly ILogger<UpdateRateSetEquipmentHandler> _logger;

    public UpdateRateSetEquipmentHandler(
        ILogger<UpdateRateSetEquipmentHandler> logger)
    {
        _logger = logger;
    }
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateRateSetEquipmentActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateRateSetEquipmentActionOutput>();
            ...
            // var resource = new UpdateRateSetEquipmentActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateRateSetEquipmentHandler" };
