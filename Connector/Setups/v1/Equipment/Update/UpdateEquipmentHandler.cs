...
namespace Connector.Setups.v1.Equipment.Update;
...
public class UpdateEquipmentHandler : IActionHandler<UpdateEquipmentAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateEquipmentActionOutput>();
            // response = await _apiClient.PostEquipmentDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetEquipmentDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateEquipmentActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(EquipmentDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateEquipmentHandler" };
