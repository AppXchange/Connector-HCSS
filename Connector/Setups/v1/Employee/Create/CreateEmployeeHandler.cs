...
public class CreateEmployeeHandler : IActionHandler<CreateEmployeeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateEmployeeActionOutput>();
            ...
            // var resource = new CreateEmployeeActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateEmployeeHandler" };
