...
public class UpdateEmployeeHandler : IActionHandler<UpdateEmployeeAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateEmployeeActionOutput>();
            ...
            // var resource = new UpdateEmployeeActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateEmployeeHandler" };
