...
public class CreateRateSetPayClassHandler : IActionHandler<CreateRateSetPayClassAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<CreateRateSetPayClassActionOutput>();
            ...
            // var resource = new CreateRateSetPayClassActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "CreateRateSetPayClassHandler" };
