...
public class UpdateRateSetPayClassHandler : IActionHandler<UpdateRateSetPayClassAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UpdateRateSetPayClassActionOutput>();
            // response = await _apiClient.PostRateSetPayClassDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetRateSetPayClassDataObject(response.Data.id, cancellationToken);

            // var resource = new UpdateRateSetPayClassActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateRateSetPayClassHandler" };
