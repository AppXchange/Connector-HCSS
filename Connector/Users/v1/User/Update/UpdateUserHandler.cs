...
public class UpdateUserHandler : IActionHandler<UpdateUserAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<UpdateUserActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<UpdateUserActionOutput>();
            ...
            // var resource = new UpdateUserActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UpdateUserHandler" };
