...
public class DeleteUserHandler : IActionHandler<DeleteUserAction>
{
    ...
    {
        var input = JsonSerializer.Deserialize<DeleteUserActionInput>(actionInstance.InputJson);
        try
        {
            // Given the input for the action, make a call to your API/system
            var response = new ApiResponse<DeleteUserActionOutput>();
            ...
            // var resource = new DeleteUserActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "DeleteUserHandler" };
